...
import { BaseUser, GetFollowListResponse, UserPreview } from ".";
import { 
...
export class Client{
     ...
     */
     public route(e:WebSocket.MessageEvent){
        ...
        console.log("inside_routing:",basic_response.response_op_code);
        console.log("inside_routing_data:",basic_response.response_containing_data);
