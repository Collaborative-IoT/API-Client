        ...
        switch(basic_response.response_op_code){
            ...
            case "you-joined-as-speaker":{
                if (this.client_sub.you_joined_as_speaker){
                    await this.client_sub.you_joined_as_speaker(JSON.parse(basic_response.response_containing_data));
                }
                break
            }
            case "you-are-now-a-speaker":{
                if (this.client_sub.you_are_now_a_speaker){
                    await this.client_sub.you_are_now_a_speaker(JSON.parse(basic_response.response_containing_data));
                }
            }
            case "you-joined-as-peer":{
                if(this.client_sub.you_joined_as_peer){
                    await this.client_sub.you_joined_as_peer(JSON.parse(basic_response.response_containing_data));
                }
                break
            }
            case "you_left_room":{
            ...
            case "new-peer-speaker":{
                if(this.client_sub.new_peer_speaker){
                   await this.client_sub.new_peer_speaker(JSON.parse(basic_response.response_containing_data));
                }
                break
            }
            ...
            case "room-created":{
                if (this.client_sub.room_created){
                    this.client_sub.room_created(JSON.parse(basic_response.response_containing_data).roomId);
                }
                break
            }
